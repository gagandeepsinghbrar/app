...
const r = [
  {
      "question": "During a routine checkup, a dental hygienist notices signs of possible domestic abuse on a patient. What is the appropriate action for the hygienist?",
      "choices": [
          "Ignore the signs and proceed with the checkup",
          "Ask the patient about the signs of abuse",
          "Report the suspected abuse to the appropriate authorities",
      ...
      "answer": "Report the suspected abuse to the appropriate authorities",
      "noScore": true,
      "answered": "Report the suspected abuse to the appropriate authorities"
  },
  {
      "question": "A dental receptionist accidentally schedules two patients for the same appointment slot. What is the ethical course of action for the receptionist?",
      "choices": [
          "Cancel one of the appointments without informing the patient",
          "Inform both patients of the scheduling error and reschedule one of them",
          "See both patients simultaneously to save time",
      ...
      "answer": "Inform both patients of the scheduling error and reschedule one of them",
      "noScore": true,
      "answered": "Inform both patients of the scheduling error and reschedule one of them"
  },
  {
      "question": "A dentist notices that a colleague is practicing dentistry without a valid license. What should the dentist do?",
      "choices": [
          "Ignore the situation as it is not their responsibility",
          "Confront the colleague directly about the lack of license",
          "Report the colleague to the state dental board",
      ...
      "answer": "Report the colleague to the state dental board",
      "noScore": true,
      "answered": "Report the colleague to the state dental board"
  },
  {
      "question": "During a dental procedure, a patient expresses discomfort and requests the dentist to stop. What should the dentist do?",
      "choices": [
          "Ignore the patient's request and continue the procedure",
          "Stop the procedure immediately and address the patient's concerns",
          "Delay stopping the procedure until it's completed",
      ...
      "answer": "Stop the procedure immediately and address the patient's concerns",
      "noScore": true,
      "answered": "Stop the procedure immediately and address the patient's concerns"
  },
  {
      "question": "A dental assistant inadvertently discloses a patient's medical history to a family member who is not authorized to access it. What action should the dental office take?",
      "choices": [
          "Dismiss the incident as accidental and not report it",
          "Inform the patient about the disclosure and apologize",
          "Ignore the incident as it's not a serious breach of confidentiality",
      ...
      "answer": "Inform the patient about the disclosure and apologize",
      "noScore": true,
      "answered": "Inform the patient about the disclosure and apologize"
  },
  {
      "question": "A patient presents a fake identification card during registration at the dental office. What should the dental office staff do?",
      "choices": [
          "Accept the fake identification and proceed with treatment",
          "Inform the patient about the consequences of presenting fake identification",
          "Report the incident to the authorities",
      ...
      "answer": "Inform the patient about the consequences of presenting fake identification",
      "noScore": true,
      "answered": "Inform the patient about the consequences of presenting fake identification",
      "marked": true
  },
  {
      "question": "A dental office manager discovers that a staff member has been stealing supplies from the office. What should the manager do?",
      "choices": [
          "Ignore the theft to avoid conflict within the staff",
          "Confront the staff member privately and warn them not to repeat the behavior",
          "Terminate the staff member's employment and report the theft to the appropriate authorities",
      ...
      "answer": "Terminate the staff member's employment and report the theft to the appropriate authorities",
      "noScore": true,
      "answered": "Terminate the staff member's employment and report the theft to the appropriate authorities",
      "marked": true
  },
  {
      "question": "A dentist discovers a minor billing error on a patient's account from a previous visit that benefits the dentist. What is the ethical course of action?",
      "choices": [
          "Ignore the error since it's minor",
          "Correct the error and refund the patient",
          "Charge the patient more to cover up the error",
      ...
      "answer": "Correct the error and refund the patient",
      "noScore": true,
      "answered": "Correct the error and refund the patient"
  },
  {
      "question": "A dental assistant accidentally breaches patient confidentiality by discussing a celebrity patient's dental work with a friend. What are the potential consequences?",
      "choices": [
          "No consequences",
          "Disciplinary action from the Dental Board and potential lawsuit",
          "Promotion for attracting more celebrities",
      ...
      "answer": "Disciplinary action from the Dental Board and potential lawsuit",
      "noScore": true,
      "answered": "Disciplinary action from the Dental Board and potential lawsuit",
      "marked": true
  },
  {
      "question": "A dentist is treating a patient with a contagious disease. What additional infection control protocols should be implemented?",
      "choices": [
          "Standard protocols only",
          "No additional protocols needed",
          "Specific PPE, disposable instruments, and stricter disinfection procedures",
      ...
      "answer": "Specific PPE, disposable instruments, and stricter disinfection procedures",
      "noScore": true,
      "answered": "No additional protocols needed"
  },
  {
      "question": "A patient requests a specific treatment even though the dentist believes it's not the best option. How can the dentist ethically address this situation?",
      "choices": [
          "Refuse to treat the patient",
          "Provide the requested treatment without discussion",
          "Explain the risks and benefits and offer alternatives",
      ...
      "answer": "Explain the risks and benefits and offer alternatives",
      "answered": "Explain the risks and benefits and offer alternatives"
  },
  {
      "question": "A dental office experiences a data breach exposing patient information. What are the reporting requirements to patients and authorities?",
      "choices": [
          "No action needed if the breach is minor",
          "Notify affected patients and potentially report to authorities",
          "Only notify the dental office staff",
      ...
      "answer": "Notify affected patients and potentially report to authorities",
      "answered": "Notify affected patients and potentially report to authorities"
  },
  {
      "question": "A hygienist observes a dental assistant performing a procedure outside their scope of practice. What should they do?",
      "choices": [
          "Ignore it as a one-time incident",
          "Report the observation to the dentist or supervisor",
          "Confront the dental assistant directly",
      ...
      "answer": "Report the observation to the dentist or supervisor",
      "answered": "Report the observation to the dentist or supervisor"
  },
  {
      "question": "A dentist is considering offering discounted dental services in exchange for positive online reviews. Is this ethical?",
      "choices": [
          "Yes, if the reviews are honest",
          "No, it's considered unethical",
          "Yes, as long as it's disclosed",
      ...
      "answer": "No, it's considered unethical",
      "answered": "No, it's considered unethical"
  },
  {
      "question": "A patient files a formal complaint against a dentist with the Dental Board. What is the typical process for investigating such complaints?",
      "choices": [
          "Immediate suspension of the dentist's license",
          "Investigation by gathering information from both parties",
          "A public hearing with media involvement",
      ...
      "answer": "Investigation by gathering information from both parties",
      "answered": "Investigation by gathering information from both parties",
      "marked": true
  },
  {
      "question": "A dentist is treating a patient who is a minor. How does informed consent differ in this situation?",
      "choices": [
          "Minors can consent on their own",
          "Parental or guardian consent is required",
          "Only the dentist's consent is needed",
      ...
      "answer": "Parental or guardian consent is required",
      "answered": "Parental or guardian consent is required"
  },
  {
      "question": "A dentist is considering participating in a research study involving a new dental product. What ethical considerations should they prioritize?",
      "choices": [
          "Financial benefits from the research company",
          "Patient safety and ethical conduct of the study",
          "Potential for personal fame and recognition",
      ...
      "answer": "Patient safety and ethical conduct of the study",
      "answered": "Patient safety and ethical conduct of the study"
  },
  {
      "question": "Scenario: A dentist is treating a patient who is a known 'difficult patient' with a history of making unreasonable demands and verbal abuse towards staff. The patient becomes verbally aggressive during the procedure. How should the dentist handle this situation?",
      "choices": [
          "Continue the procedure and document the incident.",
          "Politely but firmly explain the behavior is unacceptable and offer to reschedule when the patient can be calm.",
          "Terminate the treatment and refer the patient to another dentist.",
      ...
      "answer": "Politely but firmly explain the behavior is unacceptable and offer to reschedule when the patient can be calm.",
      "answered": "Politely but firmly explain the behavior is unacceptable and offer to reschedule when the patient can be calm."
  },
  {
      "question": "Question: A dental assistant is sterilizing instruments and discovers a broken spore test ampoule after running an autoclave cycle. What is the most appropriate course of action?",
      "choices": [
          "Reprocess the instruments using a different sterilization method.",
          "Discard the instruments and rerun the autoclave cycle with a new spore test.",
          "Consider the instruments sterilized and proceed with use.",
      ...
      "answer": "Discard the instruments and rerun the autoclave cycle with a new spore test.",
      "answered": "Reprocess the instruments using a different sterilization method."
  },
  {
      "question": "Scenario: A dentist is treating a patient who expresses a fear of needles. Which of the following actions would be MOST appropriate to manage the patient's anxiety?",
      "choices": [
          "Minimize the discussion of needles and proceed quickly with the injection.",
          "Offer the patient nitrous oxide (laughing gas) for relaxation.",
          "Assure the patient there's nothing to worry about and proceed with the injection.",
      ...
      "answer": "Offer the patient nitrous oxide (laughing gas) for relaxation.",
      "answered": "Offer the patient nitrous oxide (laughing gas) for relaxation."
  },
  {
      "question": "Question: A dental hygienist suspects a patient may be pregnant. What information should the hygienist gather before proceeding with the dental cleaning?",
      "choices": [
          "No additional information is necessary, hygienists can proceed with routine cleanings during pregnancy.",
          "The hygienist should confirm the pregnancy with a home test and adjust the cleaning based on the results.",
          "The hygienist should inquire about the trimester and any pregnancy-related complications, then adjust the cleaning procedures as needed.",
      ...
      "answer": "The hygienist should inquire about the trimester and any pregnancy-related complications, then adjust the cleaning procedures as needed.",
      "answered": "The hygienist should inquire about the trimester and any pregnancy-related complications, then adjust the cleaning procedures as needed."
  },
  {
      "question": "Scenario:  A dentist is developing a new website to advertise their practice.  Which of the following statements would be a violation of the California Dental Association Code of Ethics?",
      "choices": [
          "Listing their areas of expertise.",
          "Highlighting patient testimonials about their positive experiences.",
          "Displaying pictures of the dental office and staff.",
      ...
      "answer": "Listing their areas of expertise.",
      "answered": "Highlighting patient testimonials about their positive experiences."
  },
  {
      "question": "Question: A dental assistant accidentally exposes a patient's x-ray to excessive radiation due to a malfunctioning equipment setting. What should the assistant do FIRST?",
      "choices": [
          "Inform the dentist immediately.",
          "Retake the x-ray with the correct settings.",
          "Document the incident in the patient's chart.",
      ...
      "answer": "Inform the dentist immediately.",
      "answered": "Document the incident in the patient's chart.",
      "marked": true
  },
  {
      "question": "Scenario: A dentist is treating a patient who requests a specific cosmetic dentistry procedure. The dentist believes the procedure is unnecessary and may even be detrimental to the patient's oral health. How should the dentist address this situation?",
      "choices": [
          "Perform the procedure as requested by the patient.",
          "Explain the potential drawbacks of the procedure and present alternative options based on their professional judgment.",
          "Refer the patient to another dentist who may be willing to perform the procedure.",
      ...
      "answer": "Explain the potential drawbacks of the procedure and present alternative options based on their professional judgment.",
      "answered": "Explain the potential drawbacks of the procedure and present alternative options based on their professional judgment."
  },
  {
      "question": "Question: A dental hygienist discovers outdated information in a patient's medical history form.  For example, a medication listed is no longer being taken.  What should the hygienist do?",
      "choices": [
          "Update the information in the chart without consulting the dentist.",
          "Ignore the discrepancy and proceed with the cleaning.",
          "Note the discrepancy in the chart and inform the dentist for verification.",
      ...
      "answer": "Note the discrepancy in the chart and inform the dentist for verification.",
      "answered": "Ask the patient directly about the medication and update the chart based on their response."
  },
  {
      "question": "Scenario:  A dental office is experiencing financial difficulties and considering offering discounted services to attract new patients.  Is this practice ethical under the California Dental Association Code of Ethics?",
      "choices": [
          "Yes, offering discounts is always an ethical way to attract new patients.",
          "No, offering discounts is considered unprofessional conduct.",
          "Discounts are ethical only if the quality of care is not compromised.",
      ...
      "answer": "Discounts are ethical only if the quality of care is not compromised.",
      "answered": "Discounts are ethical only if the quality of care is not compromised.",
      "marked": true
  },
  {
      "question": "Question: A dentist is treating a minor child.  How does informed consent differ in this situation compared to an adult patient?",
      "choices": [
          "Informed consent is not required for treating minors.",
          "Informed consent must be obtained solely from the parent or guardian.",
          "The dentist should explain the treatment to the child and obtain their verbal agreement in addition to parental consent.",
      ...
      "answer": "Informed consent must be obtained solely from the parent or guardian.",
      "answered": "Informed consent must be obtained solely from the parent or guardian."
  },
  {
      "question": "Scenario: A dentist is treating a patient who exhibits signs of potential opioid abuse.  The dentist also discovers the patient is prescribed high doses of opioids from another physician.  What is the dentist's MOST appropriate course of action?",
      "choices": [
          "Refill the opioid prescription as written but document the concerns in the patient's chart.",
          "Refuse to refill the prescription and suggest alternative pain management options.",
          "Discuss the concerns with the patient and offer to taper the opioid dosage.",
      ...
      "answer": "Refuse to refill the prescription and suggest alternative pain management options.",
      "answered": "Refuse to refill the prescription and suggest alternative pain management options.",
      "marked": true
  },
  {
      "question": "Question: A dental hygienist observes a dental assistant performing a procedure outside their scope of practice, such as administering local anesthesia. What should the hygienist do?",
      "choices": [
          "A) Ignore the situation to avoid conflict with the assistant.",
          "B) Immediately confront the assistant and instruct them to stop the procedure.",
          "C) Document the incident in the patient's chart and report it to the dentist or supervisor ",
      ...
      "answer": "C) Document the incident in the patient's chart and report it to the dentist or supervisor ",
      "answered": "C) Document the incident in the patient's chart and report it to the dentist or supervisor "
  },
  {
      "question": "Scenario: A dentist is considering participating in a clinical trial for a new dental implant material. What are some KEY ethical considerations the dentist should prioritize?",
      "choices": [
          "A) Focus on the potential financial benefits of participating in the study.",
          "B) Ensure the research has proper institutional review board (IRB) approval and prioritize patient safety ",
          "C) Disclose any financial ties to the company sponsoring the research to patients involved in the trial.",
      ...
      "answer": "B) Ensure the research has proper institutional review board (IRB) approval and prioritize patient safety ",
      "answered": "D) All of the above (B & C) are crucial considerations."
  },
  {
      "question": "Question: A patient files a formal complaint against a dentist with the California Dental Board alleging substandard care. What is the TYPICAL process for investigating such complaints?",
      "choices": [
          "A) The Board will immediately suspend the dentist's license pending investigation. This is not typical unless there's imminent danger to patients.",
          "B) The Board will gather information from both parties, potentially involving a hearing or mediation process ",
          "C) The Board will rely solely on the patient's complaint and issue disciplinary action against the dentist.",
      ...
      "answer": "B) The Board will gather information from both parties, potentially involving a hearing or mediation process ",
      "answered": "B) The Board will gather information from both parties, potentially involving a hearing or mediation process "
  },
  {
      "question": "Scenario: A dental office experiences a data breach that exposes patient information, such as names, addresses, and social security numbers. What are the dentist's legal obligations in response to this incident?",
      "choices": [
          "A) There are no legal obligations to report the data breach, the dentist can simply inform affected patients.",
          "B) The dentist must report the breach to the California Dental Board but is not required to notify patients.",
          "C) The dentist must notify affected patients and potentially report the breach to relevant authorities depending on the severity of the exposure ",
      ...
      "answer": "C) The dentist must notify affected patients and potentially report the breach to relevant authorities depending on the severity of the exposure ",
      "answered": "C) The dentist must notify affected patients and potentially report the breach to relevant authorities depending on the severity of the exposure "
  },
  {
      "question": "Question: A dental assistant discovers a broken vial of disinfectant solution labeled with an unknown expiration date. What should they do?",
      "choices": [
          "A) Use the solution as long as it appears clear and has a normal odor (incorrect - expired disinfectants may be ineffective).",
          "B) Discard the solution and locate a fresh bottle of disinfectant ",
          "C) Dilute the solution with water to potentially increase its effectiveness.",
      ...
      "answer": "B) Discard the solution and locate a fresh bottle of disinfectant ",
      "answered": "B) Discard the solution and locate a fresh bottle of disinfectant "
  },
  {
      "question": "A dentist is treating a patient who is a known 'difficult patient' with a history of disruptive behavior. During the procedure, the patient becomes verbally abusive and threatens to leave without paying. How should the dentist respond?",
      "choices": [
          "A) Continue the procedure and address the payment issue later.",
          "B) Politely but firmly explain the disruptive behavior is unacceptable and offer to reschedule when the patient can be calm ",
          "C) Terminate the treatment immediately and escort the patient out of the office.",
      ...
      "answer": "B) Politely but firmly explain the disruptive behavior is unacceptable and offer to reschedule when the patient can be calm ",
      "answered": "B) Politely but firmly explain the disruptive behavior is unacceptable and offer to reschedule when the patient can be calm "
  },
  {
      "question": "A dental hygienist suspects child abuse or neglect based on observations during a patient examination. What is their legal obligation?",
      "choices": [
          "A) Discuss the concerns with the parent or guardian directly.",
          "B) Ignore the suspicion as it's not their responsibility.",
          "C) Report the suspected abuse or neglect to the appropriate authorities, such as Child Protective Services ",
      ...
      "answer": "C) Report the suspected abuse or neglect to the appropriate authorities, such as Child Protective Services ",
      "answered": "C) Report the suspected abuse or neglect to the appropriate authorities, such as Child Protective Services "
  },
  {
      "question": "Question: A registered dental assistant (RDA) can perform ALL of the following EXCEPT:",
      "choices": [
          "A) Taking dental x-rays with proper supervision ",
          "B) Polishing teeth",
          "C) Placing temporary fillings",
      ...
      "answer": "A) Taking dental x-rays with proper supervision ",
      "answered": "C) Placing temporary fillings"
  },
  {
      "question": "Scenario: A dental hygienist (RDH) discovers a patient has significant periodontal disease during a routine cleaning. Can the RDH perform scaling and root planing without dentist supervision?",
      "choices": [
          "A) Yes, scaling and root planing fall within the RDH's scope of practice.",
          "B) No, scaling and root planing require direct supervision from a dentist ",
          "C) The RDH can perform scaling but not root planing.",
      ...
      "answer": "B) No, scaling and root planing require direct supervision from a dentist ",
      "answered": "A) Yes, scaling and root planing fall within the RDH's scope of practice.",
      "marked": true
  },
  {
      "question": "Question: A dental assistant accidentally damages a dental instrument during a procedure. What should they do?",
      "choices": [
          "A) Continue using the damaged instrument.",
          "B) Inform the dentist or supervisor immediately and dispose of the instrument ",
          "C) Attempt to repair the instrument themselves.",
      ...
      "answer": "B) Inform the dentist or supervisor immediately and dispose of the instrument ",
      "answered": "B) Inform the dentist or supervisor immediately and dispose of the instrument "
  },
  {
      "question": "Scenario: A dentist delegates specific tasks to a dental assistant. Is the dentist ultimately responsible for the assistant's work?",
      "choices": [
          "A) No, the assistant is solely responsible for their actions.",
          "B) Yes, the dentist is ultimately responsible for the care provided by their auxiliary staff ",
          "C) Responsibility depends on the specific task delegated.",
      ...
      "answer": "B) Yes, the dentist is ultimately responsible for the care provided by their auxiliary staff ",
      "answered": "B) Yes, the dentist is ultimately responsible for the care provided by their auxiliary staff "
  },
  {
      "question": "Question: A dental office is considering hiring an unlicensed dental assistant. Is this legal in California?",
      "choices": [
          "A) Yes, anyone can assist a dentist regardless of licensure.",
          "B) No, all dental auxiliaries in California must be licensed for their specific role ",
          "C) It depends on the specific duties the assistant will perform.",
      ...
      "answer": "B) No, all dental auxiliaries in California must be licensed for their specific role ",
      "answered": "C) It depends on the specific duties the assistant will perform.",
      "marked": true
  },
  {
      "question": "Question: A patient arrives for their appointment with a new dental insurance plan. What is the dental office MOST obligated to do regarding the insurance?",
      "choices": [
          "A) Refuse to treat the patient until they verify the insurance information.",
          "B) Verify the patient's insurance coverage and explain any estimated out-of-pocket costs ",
          "C) Collect full payment upfront and let the patient handle reimbursement with their insurance.",
      ...
      "answer": "B) Verify the patient's insurance coverage and explain any estimated out-of-pocket costs ",
      "answered": "B) Verify the patient's insurance coverage and explain any estimated out-of-pocket costs "
  },
  {
      "question": "Scenario: A dental office submits a claim to a patient's insurance company for a completed procedure. The insurance company denies the claim partially, stating the procedure is not covered. What should the dental office do?",
      "choices": [
          "A) Accept the denial and bill the patient for the full amount.",
          "B) Review the reason for denial and potentially appeal the decision if justified ",
          "C) Ignore the denial and resubmit the claim multiple times.",
      ...
      "answer": "B) Review the reason for denial and potentially appeal the decision if justified ",
      "answered": "B) Review the reason for denial and potentially appeal the decision if justified "
  },
  {
      "question": "Question: A patient requests a specific dental treatment, but their insurance plan does not cover it. What is the dentist's ethical obligation?",
      "choices": [
          "A) Recommend the treatment and pressure the patient to pay out-of-pocket.",
          "B) Explain the treatment options, including those covered by insurance, and allow the patient to decide ",
          "C) Discourage the patient from pursuing the uncovered treatment.",
      ...
      "answer": "B) Explain the treatment options, including those covered by insurance, and allow the patient to decide ",
      "answered": "B) Explain the treatment options, including those covered by insurance, and allow the patient to decide "
  },
  {
      "question": "Scenario: A dental office is accused of insurance fraud by submitting false or inflated claims. What could be the potential consequences?",
      "choices": [
          "A) The dentist may receive a warning letter from the insurance company.",
          "B) The dental office may face fines and potential loss of provider status with the insurance company ",
          "C) The dentist may lose their dental license but face no criminal charges.",
      ...
      "answer": "B) The dental office may face fines and potential loss of provider status with the insurance company ",
      "answered": "B) The dental office may face fines and potential loss of provider status with the insurance company "
  },
  {
      "question": "Question: A dentist operates a solo practice under their own name. Do they need to register a fictitious name in California?",
      "choices": [
          "A) Yes, all dentists practicing under a name other than their own require fictitious name registration ",
          "B) No, registration is only required for businesses with multiple owners.",
          "C) Registration is optional but recommended for legal protection.",
      ...
      "answer": "A) Yes, all dentists practicing under a name other than their own require fictitious name registration ",
      "answered": "C) Registration is optional but recommended for legal protection."
  },
  {
      "question": "Scenario: A dentist partners with another dentist and wants to operate under a new business name. When should they file a fictitious name statement?",
      "choices": [
          "A) Before they begin practicing together ",
          "B) Within 30 days of starting the partnership.",
          "C) Fictitious name registration is not required for partnerships.",
      ...
      "answer": "A) Before they begin practicing together ",
      "answered": "B) Within 30 days of starting the partnership."
  },
  {
      "question": "A dentist wants to operate their practice under a name that includes their own last name but with a different first name. Does this require fictitious name registration?",
      "choices": [
          "A) Yes, any name variation from the dentist's legal name requires registration ",
          "B) No, registration is not needed if the name still clearly identifies the dentist.",
          "C) Registration depends on whether the dentist advertises the new name.",
      ...
      "answer": "A) Yes, any name variation from the dentist's legal name requires registration ",
      "answered": "A) Yes, any name variation from the dentist's legal name requires registration "
  },
  {
      "question": "Scenario: A dentist files a fictitious name statement for their practice. How long is the statement valid?",
      "choices": [
          "A) The statement is valid for one year and needs annual renewal.",
          "B) The fictitious name registration remains valid indefinitely ",
          "C) The statement expires after five years and needs to be refiled.",
      ...
      "answer": "B) The fictitious name registration remains valid indefinitely ",
      "answered": "C) The statement expires after five years and needs to be refiled."
  },
  {
      "question": "A dentist wants to change the name of their existing practice that is already registered as a fictitious name. What needs to be done?",
      "choices": [
          "A) File a new fictitious name statement with the chosen new name ",
          "B) No further action is required, the existing registration applies to any name change.",
          "C) Notify the county clerk's office of the name change.",
      ...
      "answer": "A) File a new fictitious name statement with the chosen new name ",
      "answered": "A) File a new fictitious name statement with the chosen new name ",
      "marked": true
  },
  {
      "question": "Scenario: A dentist is considering purchasing an existing dental practice with a registered fictitious name. What steps should they take regarding the fictitious name?",
      "choices": [
          "A) The new owner automatically inherits the existing fictitious name registration.",
          "B) The new owner needs to file a new fictitious name statement under their own name ",
          "C) The previous owner should cancel their fictitious name registration.",
      ...
      "answer": "B) The new owner needs to file a new fictitious name statement under their own name ",
      "answered": "A) The new owner automatically inherits the existing fictitious name registration."
  },
  {
      "question": "A dentist files a fictitious name statement in one California county. Is this registration valid for practicing in other counties?",
      "choices": [
          "A) No, a separate fictitious name statement needs to be filed in each county ",
          "B) Registration in one county allows practicing anywhere in California.",
          "C) The validity depends on the specific county regulations.",
      ...
      "answer": "A) No, a separate fictitious name statement needs to be filed in each county ",
      "answered": "A) No, a separate fictitious name statement needs to be filed in each county "
  },
  {
      "question": "Scenario: A dentist fails to register their fictitious name as required by law. What are the potential consequences?",
      "choices": [
          "A) They may face fines and potential legal challenges from other businesses with similar names. ",
          "B) The dentist could lose their dental license.",
          "C) There are no consequences for not registering a fictitious name.",
      ...
      "answer": "A) They may face fines and potential legal challenges from other businesses with similar names. ",
      "answered": "A) They may face fines and potential legal challenges from other businesses with similar names. ",
      "marked": true
  },
  {
      "question": "Where can a dentist find the official California Fictitious Name Statement form?",
      "choices": [
          "A) The form can be obtained from the California Dental Board website.",
          "B) The form is available at the dentist's local county clerk's office ",
          "C) Fictitious name statement forms can be downloaded from various online legal resources.",
      ...
      "answered": "A) The form can be obtained from the California Dental Board website.",
      "answer": "A) The form can be obtained from the California Dental Board website."
  },
  {
      "question": "A dentist wants to operate their practice under a name that includes their own last name but with a different first name (e.g., \"Dr. Smile Jones\" vs. real name \"John Smith\"). Does this require fictitious name registration?",
      "choices": [
          "Yes, any name variation from the dentist's legal name requires registration",
          "No, registration is not needed if the name still clearly identifies the dentist.",
          "Registration depends on whether the dentist advertises the new name.",
      ...
      "answer": "No, registration is not needed if the name still clearly identifies the dentist.",
      "answered": "Yes, any name variation from the dentist's legal name requires registration"
  },
  {
      "question": "Scenario: A dentist files a fictitious name statement for their practice. How long is the statement valid?",
      "choices": [
      ...
      "answer": "The fictitious name registration remains valid indefinitely",
      "answered": "The statement expires after five years and needs to be refiled."
  },
  {
      "question": "A dentist wants to change the name of their existing practice that is already registered as a fictitious name. What needs to be done?",
      "choices": [
      ...
      "answer": "File a new fictitious name statement with the chosen new name",
      "answered": "File a new fictitious name statement with the chosen new name"
  },
  {
      "question": "Scenario: A dentist is considering purchasing an existing dental practice with a registered fictitious name. What steps should they take regarding the fictitious name?",
      "choices": [
      ...
      "answer": "The new owner needs to file a new fictitious name statement under their own name",
      "answered": "The new owner automatically inherits the existing fictitious name registration."
  },
  {
      "question": "A dentist files a fictitious name statement in one California county. Is this registration valid for practicing in other counties?",
      "choices": [
      ...
      "answer": "No, a separate fictitious name statement needs to be filed in each county",
      "answered": "No, a separate fictitious name statement needs to be filed in each county"
  },
  {
      "question": "Scenario: A dentist fails to register their fictitious name as required by law. What are the potential consequences?",
      "choices": [
      ...
      "answer": "They may face fines and potential legal challenges from other businesses with similar names.",
      "answered": "They may face fines and potential legal challenges from other businesses with similar names."
  },
  {
      "question": "Where can a dentist find the official California Fictitious Name Statement form?",
      "choices": [
      ...
      "answer": "The form is available at the dentist's local county clerk's office",
      "answered": "The form can be obtained from the California Dental Board website."
  }
]
  ...
  fetch("/submit-quiz", {
    ...
    body: JSON.stringify({ result_data: JSON.stringify(r) }),
  })
    .then((response) => response.json())
    .then((data) => console.log(data))
    .catch((error) => console.error("Error:", error));